  ...
  return (
    <section>
      <article className='aCard'>
        ...
        <p>I'm <span>Lucas</span> web developer from Utah, who loves to create and problem solve. I'm currently working with the MERN Stack but concurrently learning new technologies.  I have a certificate from the University of Utah for Full Stack Coding and during the program I was <span>Team Lead</span> for every project.</p>
        <div className='aImg'>
