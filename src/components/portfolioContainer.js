...
const projects = [
  {
    ...
    description:
      "This website was created using the MERN stack to show our proficiency with the tools included. Our motivation was to build a fast responding E-commerce site that a user could add items to a wishlist or to their cart.",
    url: `https://erics-emporium.herokuapp.com/`,
    githubURL: "https://github.com/ccottrell52/E-commerce-Project3",
    image:
      "./assests/images/screencapture-erics-emporium-herokuapp-2022-11-30-09_40_46.png",
  ...
  },
  {
    ...
    name: "Tech Blogger",
    description:
      "This is a Full Stack single page application that uses a mySQL Database and is hosted on Heroku.  It uses many differenet technologies such as HTML, CSS, Bootstrap, JavaScript, Express.js, Node.js, mySQL, Sequilize (mySQL ORM), bcrypt, and was developed with nodemon.",
  ...
  },
  {
    ...
    image:
      "./assests/images/screencapture-mountaindriver-github-io-super-team-project-2022-11-04-13_37_19.png",
    tech: `HTML, CSS, JavaScript, Bootstrap, jQuery, Third Party API`,
    technologies: [
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    image:
      "https://user-images.githubusercontent.com/106941418/193163516-b5a97c92-7a7d-400b-955e-db0a362c4d94.png",
    tech: `Express, Node, MySQL, Sequlized, bcrypt, .env`,
    technologies: [
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    description:
      "This is an API that is created using MongoDB and JavaScript. The database uses Express.js and Mongoose as the ORM. This is not a deployed website but there is a link to a walk through video in the README.",
    ...
    technologies: ["MonogoDB", "Mongoose", "Node.js", "Express", "Insomnia"],
  },
];
